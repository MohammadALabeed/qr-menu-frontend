...
// رابط الـ API المعتمد للسيرفر الجديد أو من متغير بيئة Vite
const API_URL =
...
function Dashboard() {
  ...
  const playNotificationSound = () => {
    ...
    audio
      .play()
      .catch(() =>
        console.log("تنبيه: يحتاج تفاعل من المستخدم أولاً لتشغيل الصوت"),
      );
  };
  ...
  const handleAddItem = (e) => {
    ...
    if (!newItem.name || !newItem.price)
      return alert("الرجاء ملء اسم الوجبة وسعرها ⚠️");
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            برجاء إدخال بيانات الأدمن للمتابعة
          </p>
    ...
    >
        ...
        >
          <button
            ...
            style={{
              ...
              color: activeSubTab === "live-orders" ? "#34d399" : "#cbd5e1",
            }}
          >
            🔥 الطلبات (
          ...
          <button
            onClick={() => setActiveSubTab("menu-manage")}
            style={{
              padding: "10px 20px",
              borderRadius: "12px",
              cursor: "pointer",
              ...
              backgroundColor:
                activeSubTab === "menu-manage"
                  ...
                  : "rgba(255,255,255,0.04)",
              color: activeSubTab === "menu-manage" ? "#60a5fa" : "#cbd5e1",
            }}
          >
            🍽️ إدارة المنيو ({Array.isArray(menu) ? menu.length : 0})
          </button>
          <button
            onClick={() => setActiveSubTab("feedback-log")}
            style={{
              padding: "10px 20px",
              borderRadius: "12px",
              cursor: "pointer",
              ...
              backgroundColor:
                activeSubTab === "feedback-log"
                  ...
                  : "rgba(255,255,255,0.04)",
              color: activeSubTab === "feedback-log" ? "#fbbf24" : "#cbd5e1",
            }}
          >
            📣 التقييمات ({Array.isArray(feedbacks) ? feedbacks.length : 0})
          </button>
          <button
            onClick={() => setActiveSubTab("general-settings")}
            style={{
              padding: "10px 20px",
              borderRadius: "12px",
              cursor: "pointer",
              ...
              backgroundColor:
                activeSubTab === "general-settings"
                  ...
                  : "rgba(255,255,255,0.04)",
              color:
                activeSubTab === "general-settings" ? "#c084fc" : "#cbd5e1",
            }}
          >
            ⚙️ الإعدادات العامة
          </button>
              ...
              >
                ...
                >
                  ...
                  <span
                    style={{
                      color:
                        order.status === "completed" ? "#34d399" : "#f87171",
                    }}
                  >
                          ...
                          style={{
                            ...
                            backgroundColor:
                              item.is_available === 1
                                ...
                                : "rgba(239, 68, 68, 0.15)",
                            color:
                              item.is_available === 1 ? "#34d399" : "#f87171",
                          }}
                        >
                          {item.is_available === 1
                            ? "🟢 متوفر"
      ...
      {activeSubTab === "feedback-log" && (
        <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
          <div
            className="stars-analytics-card"
            style={{
              backgroundColor: "rgba(15, 22, 38, 0.9)",
              color: "#fff",
              padding: "20px",
          ...
          {Array.isArray(feedbacks) &&
            feedbacks.map((fb) => (
              ...
              >
                طاولة {fb.table_number}: {fb.comment}{" "}
                {fb.rating && `(التقييم: ${fb.rating} ⭐)`}
              </div>
            ))}
        </div>
      )}
      ...
      {activeSubTab === "general-settings" && (
        <div style={{ maxWidth: "700px", margin: "0 auto" }}>
          ...
          >
            ...
            >
              ⚙️ إعدادات المتجر والمطعم العامة
            </h3>
                ...
                style={{
                  backgroundColor:
                    settingsMessage.type === "success"
                      ...
                      : "rgba(239, 68, 68, 0.15)",
                  color:
                    settingsMessage.type === "success" ? "#34d399" : "#f87171",
                  padding: "12px",
                  borderRadius: "10px",
                  marginBottom: "20px",
                  fontSize: "15px",
            ...
            >
              ...
              <div>
                ...
                >
                  رابط اللوجو / صورة المطعم الأساسية:
                </label>
                <input
                  type="text"
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="مثال: 12:00 PM - 12:00 AM"
                  style={{
                    width: "100%",
                    padding: "12px",
                    borderRadius: "10px",
